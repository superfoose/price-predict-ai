...
def ml_sma(df):
    ...
    def generate_labels(df):
        ...
        df.loc[((df["SMA_10"] > df["close"])), 'Trend'] = 1  # Bullish trend

        df.loc[(df["SMA_10"] < df["close"]), 'Trend'] = -1  # Bearish trend
    ...
    features = ['RSI_14', "SMA_14", "SMA_10", "MACD_12_26_9", "RSI_5"]  # Add more indicators if needed
